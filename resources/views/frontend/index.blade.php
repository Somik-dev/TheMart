    ...
    <div class="container">
        ...
        <div class="featured-categorie-slider owl-carousel">
            ...
            <div class="featured-item">
                <div class="images">
                    <img style="width: 70px!important; margin:auto;" src="{{ asset('uploads/categories') }}/{{ $category->category_img }}" alt="">
                </div>
                <div class="text">
                    <h2><a href="{{ route('category.products', $category->id) }}">{{ $category->category_name }}</a></h2>
                </div>
            </div>
            @endforeach
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="product-item">
                        <div class="image">
                            <img height="250" src="{{ asset('uploads/products/preview') }}/{{ $product->preview }}" alt="">
                            @if ($product->discount)
                        ...
                        <div class="text">
                            <h2><a href="{{ route('product.details', $product->slug) }}" title="{{ $product->product_name }}">
                                ...
                                $total_stars = App\Models\OrderProduct::where('product_id',$product->id)->whereNotNull('review')->sum('stars');
                            ...
                            <div class="rating-product">
                                ...
                                @endfor
                                <span>{{  $total_reviews == 0?'':$total_reviews }}</span>
                            </div>
                            <div class="price">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="highlight-wrap">
                    ...
                    <div class="product-card">
                        <div class="card-image">
                            <div class="image">
                                <img width="100" height="100" src="{{ asset('uploads/products/preview') }}/{{ $product->preview }}" alt="">
                            </div>
                        </div>
                        <div class="content">
...
<section class="themart-cta-section section-padding" id="sub">
    <div class="container">
        <div class="cta-wrap">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-12">
                    <div class="cta-content">
                        ...
                        <form action="{{ route('subscriber.store') }}" method="POST">
                            ...
                            @if (session('Subs'))
                            <div class="alert alert-success mt-2">{{ session('Subs') }}</div>
                            @endif
                        </form>
                    </div>
