                            ...
                            <div class="middle-box">
                                ...
                                <div class="search-box">
                                    <div class="input-group">
                                        ...
                                        <button class="search-btn ddd" type="submit"> <i class="fi flaticon-search"></i>
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="middle-right">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        @else
                                        <a href="{{ route('customer.login') }}"><i class="fi flaticon-user-profile"></i><span>
                                        Login</span></a>
                                        @endauth
                                    </li>
                                    <li>
                                        ...
                                        <div class="mini-cart">
                                            ...
                                            <div class="mini-cart-content">
                                                ...
                                                <div class="mini-cart-items">
                                                    ...
                                                    <div class="mini-cart-item clearfix">
                                                        <div class="mini-cart-item-image">
                                                            <a href="product.html"><img src="{{ asset('uploads/products/preview') }}/{{ $cart->rel_to_product->preview }}" alt></a>
                                                        </div>
                                                        <div class="mini-cart-item-des">
                                                            <a href="product.html">{{ Str::substr($cart->rel_to_product->product_name, 0, 20).'..' }}</a>
                                                        </div>
                                                        <div class="d-flex">
                                                            <span class="mini-cart-item-quantity">Color:{{ $cart->rel_to_color->color_name }}</span>
                                                            &nbsp;
                                                            <span class="mini-cart-item-quantity">Size:{{ $cart->rel_to_size->size_name }}</span>
                                                        </div>
                                                        <div class="mini-cart-item-des">
                                    ...
                                    <div class="mini-shop-item">
                                        <ul id="metis-menu">
                                            ...
                                            <li class="header-catagory-item">
                                                <a class="menu-down-{{ App\Models\newsubcategory::where('category_id', $category->id)->count() != 0?'arrow':'' }}" href="#">{{ $category->category_name }}</a>
                                                <ul class="header-catagory-single">
                                                    @foreach (App\Models\newsubcategory::where('category_id', $category->id)->get() as $subcategory)
                                                    <li><a href="{{ route('subcategory.products',$subcategory->id) }}">{{ $subcategory->category_name }}</a></li>
                                                    @endforeach
                                                </ul>
                                            </li>
                                            @endforeach
