                            ...
                            <tbody>
                              ...
                              <tr>
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                  {{ App\Models\Billing::where('order_id', $order_id)->first()->fname }}<br> {{ App\Models\Billing::where('order_id', $order_id)->first()->address }}<br>{{ App\Models\Billing::where('order_id', $order_id)->first()->rel_to_city->name }}<br> {{ App\Models\Billing::where('order_id', $order_id)->first()->zip }}, {{ App\Models\Billing::where('order_id', $order_id)->first()->rel_to_country->name }}<br> T: {{ App\Models\Billing::where('order_id', $order_id)->first()->phone }}
                                </td>
                              </tr>
                            </tbody>
                          </table>
                        ...
                        <td>
                          <table width="220" border="0" cellpadding="0" cellspacing="0" align="left" class="col">
                            <tbody>
                              ...
                              <tr>
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                    {{ App\Models\Shipping::where('order_id', $order_id)->first()->ship_fname }}<br>  {{ App\Models\Shipping::where('order_id', $order_id)->first()->ship_adress }}<br>{{ App\Models\Shipping::where('order_id', $order_id)->first()->rel_to_city->name }}<br> {{ App\Models\Shipping::where('order_id', $order_id)->first()->ship_zip }},{{ App\Models\Shipping::where('order_id', $order_id)->first()->rel_to_country->name }}<br> T: {{ App\Models\Shipping::where('order_id', $order_id)->first()->ship_phone }}
                                </td>
                              </tr>
                            </tbody>
                          </table>
