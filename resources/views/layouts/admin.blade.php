		...
		<div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                   <li><a class="has-arrow ai-icon" href="{{route('dashboard')}}">
                    ...
                    <li><a href="{{ route('orders') }}" class="ai-icon" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('product') }}">Add New Products</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="{{ route('subscriber') }}" aria-expanded="false">
                     ...
                     <li><a class="has-arrow ai-icon" href="{{ route('role') }}" aria-expanded="false">
							<i class="flaticon-381-layer-1"></i>
							<span class="nav-text">Role Maneger</span>
						</a>
                    </li>
                </ul>
